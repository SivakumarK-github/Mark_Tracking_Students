        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult" method="">
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Java</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">MySql</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Project</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Activity</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Front-End</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="">
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Web Development</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="">
                                    </div>
                                </div>
